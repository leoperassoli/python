...
os novos recursos também otimizam a execução, pois vetorizam o codigo, ou seja, <a href="https://github.com/leoperassoli/python/blob/master/pandas/Series_Python.ipynb#Percorrendo-uma-s%C3%A9rie">substituem laços por funções da biblioteca</a> tornando o código mais rápido e legível.  
