...
os novos recursos também otimizam a execução, pois vetorizam o codigo, ou seja, [substituem laços por funções da biblioteca](https://github.com/gabrieladslopes/DevRadar/blob/master/README.md#setup) tornando o código mais rápido e legível.  
