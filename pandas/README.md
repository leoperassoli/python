...
os novos recursos também otimizam a execução, pois vetorizam o codigo, ou seja, [substituem laços por funções da biblioteca](https://nbviewer.jupyter.org/github/leoperassoli/python/blob/master/pandas/Series_Python.ipynb#Otimizando-a-iteração) tornando o código mais rápido e legível.  
