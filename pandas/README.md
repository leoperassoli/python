...
os novos recursos também otimizam a execução, pois vetorizam o codigo, ou seja, [substituem laços por funções da biblioteca](Series_Python.ipynb#teste) tornando o código mais rápido e legível.  
